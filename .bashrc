...
alias auu='sudo su -c "set -x; apt-get update && apt-get upgrade && apt-get dist-upgrade && apt-get clean && apt-cache gencaches && apt-get autoremove && aptitude purge ~c && aptitude forget-new"'
